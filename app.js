...
// localStorage.setItem("text", "this is a link 2");
// localStorage.setItem("text1", "this is a link 3");
// localStorage.setItem("text2", "this is a link 4");
// localStorage.setItem("text3", "this is a link 5");
